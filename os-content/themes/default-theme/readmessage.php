...
<div id="main-content">
	<?php
	echo "<div id=\"breadcrumb_trail\" style=\"margin-bottom: 10px\"><h4><a href=\"messages.php\">Inbox</a> > $title [<a href=\"profile.php?id={$users['user_sent']['ID']}\" style=\"color: #777777;\">{$users['user_sent']['name']}</a> & <a href=\"profile.php?id={$users['user_received']['ID']}\" style=\"color: #777777;\">{$users['user_received']['name']}</a>]</h4></div>";
