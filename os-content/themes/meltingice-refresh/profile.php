...
if($_GET['id'])
{
	$userColor = $osimo->getUsernameColor($_GET['id']);
}
else
{
	$user = $osimo->getLoggedInUser();
	$userColor = $osimo->getUsernameColor($user['ID']);
}
?>
...
<div id="main-content">
	<div class="category-container">
		<div class="profile-header-container">
			<div class="profile-header">
				...
				<div class="profile-header-right">
					<h4 <? if($userColor){ echo "style=\"color:$userColor !important;\""; } ?>><?php echo $user_info['username']; ?></h4>
		...
		<div id="profile-bottom-info">
			<div class="profile-other-info" style="float: left">
				<h4><small>Biography</small></h4>
				<div id="profile_bio">
					<p><?php echo $user_info['field_biography']; ?></p>
				</div>
			</div>
			<div class="profile-other-info" style="float: right">
